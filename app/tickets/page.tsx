    ...
    <div className='w-[100%]'>
      ...
      <div className='px-24 py-10'>
          ...
          <TicketTimeTracker tickets={tickets} />
            ...
            <div className='bg-[#EFEFF0] rounded-3xl w-[40%] px-14 py-8'><h1 className='text-2xl font-semibold text-center'> Select a existing ticket to log time <br /> or <br /><span className='underline underline-offset-2'>Create a new one</span> </h1> 
              <div className='pt-20'>
